...
call <sid>hi('pythonBuiltin'               , '0D'  , ''       , '')
call <sid>hi('pythonBuiltinObj'            , '0D'  , ''       , '')
call <sid>hi('pythonBuiltinFunc'           , '0D'  , ''       , '')
call <sid>hi('pythonBoolean'               , '09'  , ''       , '')
call <sid>hi('pythonExceptions'            , '09'  , ''       , '')
call <sid>hi('pythonDecorator'             , '05'  , ''       , '')
call <sid>hi('pythonFunction'              , '0D'  , ''       , '')
call <sid>hi('pythonInclude'               , '0D'  , ''       , '')
call <sid>hi('pythonImport'                , '0D'  , ''       , '')
call <sid>hi('pythonCoding'                , '0D'  , ''       , '')
call <sid>hi('pythonRun'                   , '0D'  , ''       , '')
call <sid>hi('pythonOperator'              , '05'  , ''       , '')
call <sid>hi('pythonException'             , '05'  , ''       , '')
call <sid>hi('pythonRepeat'                , '0A'  , ''       , '')
call <sid>hi('pythonConditional'           , '0A'  , ''       , '')
call <sid>hi('pythonDot'                   , '0C'  , ''       , '')
call <sid>hi('pythonDottedName'            , '0F'  , ''       , '')
call <sid>hi('pythonStatement'             , '08'  , ''       , '')
